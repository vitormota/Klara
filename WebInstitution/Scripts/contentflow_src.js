...
ContentFlowItem.prototype = {
    ...
    makeActive: function () {
        ...
        var arr = $('.active img').attr('src').split('/');
        var item = arr[arr.length - 1];

        if (item == "pictogramas-03.png")
            $('#settings a').click();
        else if (item == "pictogramas-02.png")
            $('#localization a').click();
        else if (item == "pictogramas-08.png")
            $('#add-cupon a').click();
        else if (item == "pictogramas-05.png")
            $('#edit-cupons a').click();
        else if (item == "pictogramas-07.png")
            $('#stats a').click();
    },
